...
%----------------------------------------------------------
\newcommand*{\wscoclogo}{logo} % Generic publisher logo
%----Begin Custom Title
...
{\noindent\LARGE\bfseries ``For They Shall All Know Me''}\\[\baselineskip]
{\Large \textit{Developing a New Covenant Relationship with God}}\\[2\baselineskip]
{\noindent\LARGE TEACHERS MANUAL}\\[4\baselineskip]


{\Large \textsc{Todd Jobe}} % Author name

\vspace{0.5\textheight} % Whitespace between the title block and the publisher
{\noindent Walnut Street Church of Christ \wscoclogo}\\[\baselineskip] % Publisher and logo
}}
\endgroup}
%----End Custom Title
%---------Old Title----------------------------------------------------------
...
\specialcomment{questions}{
	...
	\clearpage
	\section*{Questions}
	\begin{enumerate} \itemsep1pt \parsep200pt
}
{
	\end{enumerate}
}
